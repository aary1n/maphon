...
- **S3 / S5**: S3 label reserved (numbering fork S3-vs-S4 rides Email B — the SPEC outcome's NUMBERING UNCONFIRMED caveat restated); S5 logged-deferred. No numbers. *(2026-07-21: the Email B ask is CLOSED AS UNRECOVERABLE — joint recall failure, neither Oxborrow nor the notetaker remembers; notes archived at `calibration/data/raw/oxborrow_meeting_notes_2026-07-21/`. S3 is permanently content-lost; the numbering caveat is permanent; no renumbering.)*
